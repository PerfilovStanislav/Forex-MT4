...
bool checkStochastic(int cmd) {  
   ...
   if (  
      ...
      else if  (Direction(cmd+Stochastic_direction, stochastic, iStochastic(NULL, 0, Stochastic_k_period, Stochastic_d_period, Stochastic_slowing, int(Stochastic_method), int(Stochastic_field), MODE_MAIN, 1))) return (true);
   }
